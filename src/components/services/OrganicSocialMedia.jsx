    ...
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      <div className="flex justify-start gap-5">
        ...
        <button
          ...
          onClick={handleNext}
          className="bg-[#000] text-[white] rounded-lg px-4 py-2 hover:bg-gray-700 transition"
        >
          Next
        </button>
      </div>
...
//       const postsPerWeek = Number(charges[platform]) || 0;
//       const costPerPost = calculatePlatformCost(platform, postsPerWeek);
//       totalCost += postsPerWeek * costPerPost;
//     });
...
//                   type="number"
//                   min="0"
//                   value={calculatePlatformCost(platform)}
//                   readOnly
//                   className="border-none p-2 text-center w-[250px]"
//                   placeholder="Cost"
//                 />
...
//       </div>
//       <div className="flex justify-between items-center mb-4">
//         {/* Optional: You can add more summary details here */}
//       </div>
//       <div className="flex justify-start gap-5">
//         <button
//           onClick={() => navigate(-1)}
